...
nmap({ '<leader>pX', '<cmd>Lazy clean<cr>' })
nmap({ '<leader>pU', '<cmd>Lazy sync<cr>' })
nmap({ '<leader>pS', '<cmd>Lazy show<cr>' })
nmap({ '<leader>pR', '<cmd>Lazy restore<cr>' })
nmap({ '<leader>pP', '<cmd>Lazy profile<cr>' })
