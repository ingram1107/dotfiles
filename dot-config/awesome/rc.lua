...
globalkeys = gears.table.join(
  ...
  end, { description = 'iterates through the currently focused tabbing group', group = 'tab' }),
  ...
  awful.key({ modkey }, 'e', function()
    element_scratch:toggle()
  end, { description = 'open element-desktop', group = 'programs' }),
  ...
  awful.key({ 'Shift' }, 'Print', function()
    awful.util.spawn("scrot -d 1 -s -e 'mv $f ~/Pictures/'", false)
  end, { description = 'screen shot', group = 'screen' })
)
