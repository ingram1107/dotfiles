...
theme.bg_focus    = "#a6e221"
theme.bg_urgent   = "#f92642"
theme.bg_minimize = "#46830c"
...
theme.tag_fg_focus    = "#66e9ef"
theme.tag_fg_urgent   = theme.bg_urgent
theme.tag_fg_occupied = theme.bg_focus
theme.tag_fg_empty    = "#75715e"
...
theme.awesome_icon = theme_assets.awesome_icon(
    0, theme.bg_focus, theme.fg_focus
)
